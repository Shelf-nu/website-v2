...
const TYPE_LABELS: Record<string, { label: string; color: string }> = {
    ...
    "Knowledge Base": { label: "KB", color: "bg-emerald-50 text-emerald-700 border-emerald-200" },
    Feature: { label: "Feature", color: "bg-orange-50 text-orange-700 border-orange-200" },
    Solution: { label: "Solution", color: "bg-purple-50 text-purple-700 border-purple-200" },
    "Case Study": { label: "Case Study", color: "bg-pink-50 text-pink-700 border-pink-200" },
    Alternative: { label: "Alternative", color: "bg-yellow-50 text-yellow-700 border-yellow-200" },
    Industry: { label: "Industry", color: "bg-cyan-50 text-cyan-700 border-cyan-200" },
    Glossary: { label: "Glossary", color: "bg-gray-50 text-gray-700 border-gray-200" },
                                        ...
                                        <li key={url} role="option" aria-selected={i === activeIndex}>
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    {item.excerpt && (
                                                        <p
                                                            className="mt-0.5 text-xs text-muted-foreground line-clamp-2 [&_mark]:bg-orange-100 [&_mark]:text-orange-900 [&_mark]:rounded-sm [&_mark]:px-0.5"
