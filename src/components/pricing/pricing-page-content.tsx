...
// The interactive body of /pricing. The route file (src/app/(marketing)/pricing/page.tsx)
// stays a server component and wraps this in PagefindWrapper; see the note there.
