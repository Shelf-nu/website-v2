...
export const metadata = {
    title: "Product - Shelf Asset Management",
    description: "The complete operating system for physical asset management.",
};
            ...
            <Container className="py-24 md:py-32 relative">
                <div className="max-w-3xl mx-auto text-center mb-24">
                    <ScrollReveal width="100%">
                        <Badge variant="secondary" className="mb-4 bg-orange-50 text-orange-700 border-orange-100/50">Product</Badge>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {productFeatures.map((feature, index) => (
                        <ScrollReveal key={feature.title} width="100%" delay={index * 0.05} className="h-full">
