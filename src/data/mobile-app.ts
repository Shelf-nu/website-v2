...
export const mobileAppFaqs: MobileAppFAQ[] = [
    ...
    },
    {
        ...
        answer: "Yes, from version 1.5.0. Tap \"Connect to a private server\" on the sign-in screen and enter your organization's domain — the field takes your work email, your company's domain, or your Shelf server address. The app then points itself at your instance, and you sign in with your password or your company's single sign-on against your own server. Two things have to be true first: Shelf has to register your domain, and your instance has to be reachable from the phone over HTTPS. Registration comes with a private-server license from Shelf, billed as a monthly subscription, so contact sales to set it up; the change itself is on Shelf's side and needs no new app build. A domain Shelf has not registered is refused rather than quietly sent to Shelf Cloud. You can return to Shelf Cloud at any time from the sign-in screen or from Settings. See: /knowledge-base/connect-shelf-companion-to-your-own-server",
    },
    {
