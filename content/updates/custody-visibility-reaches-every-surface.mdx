...
- **The custodian picker on quantity-tracked assets.** It now offers the same people the search behind it already offered, rather than seeding from the full team list.
