...
![Assigning custody of a tool to a crew member — Shelf's check-out UX with the team member picker open](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/solutions/equipment-check-in-assign-custody.webp)
