...
<Callout type="info" title="Update: Now on iPhone and Android">

Shelf Companion is live on the [App Store](https://apps.apple.com/app/id6765639874) (iPhone) and [Google Play](https://play.google.com/store/apps/details?id=com.shelf.companion) (Android). Free with any Shelf account, including the free tier. The post below is the original pre-launch piece explaining why we built it.
...
**Shelf Companion is live on the [App Store](https://apps.apple.com/app/id6765639874) (iPhone) and [Google Play](https://play.google.com/store/apps/details?id=com.shelf.companion) (Android).** Free with any Shelf account, including the free tier. Sign in with the credentials you already use on shelf.nu and you're in.
