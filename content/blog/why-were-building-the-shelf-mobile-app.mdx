...
description: >-
  ...
  something the browser can't fully deliver. Here's why we built a native
  companion app — and what it does (and doesn't).
layout: blog
canonicalUrl: >-
...
seo:
  title: "Why We Built the Shelf Mobile App — Web-First, Field-Ready"
  description: >-
    ...
    the thinking behind Shelf Companion, now live on the App Store.
  keywords:
    - shelf mobile app
    - shelf companion
    - shelf app
...
<Callout type="info" title="Update — May 25, 2026: Now Available">

Shelf Companion for iPhone is live on the [App Store](https://apps.apple.com/app/id6765639874). Free with any Shelf account, including the free tier. Android is in development; we'll announce it when it's ready. The post below is the original pre-launch piece explaining why we built it.
...
Fair question. In August 2024, we wrote an entire post explaining [how we used to think about native apps](/blog/why-shelf-doesnt-have-native-apps-embracing-the-power-of-progressive-web-applications) — making the case for PWAs and the web-first approach. We meant every word of it, and we still stand behind that philosophy for the core platform.

We also already have a [progressive web app](/knowledge-base/shelf-mobile-app) that you can install on your home screen. It works well for day-to-day access. So why go native now?
...
**Shelf Companion for iPhone is live on the [App Store](https://apps.apple.com/app/id6765639874).** Free with any Shelf account, including the free tier. Sign in with the credentials you already use on shelf.nu and you're in.

Android is in development. We don't have a release date yet — when it's ready, we'll announce it. If you'd like a heads-up, [join the Android notify-me list](/mobile-app).
...
But we've heard our users loud and clear: field operations need something the browser can't fully deliver. So we built it. Purpose-built, honest about what it does and doesn't do, and shaped by the people who use it every day.

If that's you — [download Shelf Companion on the App Store](https://apps.apple.com/app/id6765639874).
