...
seo:
  ...
  keywords: []
  noindex: false
image: "https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/blog/new-custom-fields-on-shelf.jpeg"
---
...
Apply specific fields only to relevant [asset categories](/knowledge-base/using-categories-to-organize-your-asset-inventory). For example, show "Calibration Date" only for lab equipment.
...
"Single-line text for asset tags, Boolean fields for warranty status, and Date fields for replacement planning. Our [IT asset tracking](https://www.shelf.nu/solutions/it-asset-management) has never been more organized."
...
[Try Shelf free](https://app.shelf.nu/join?utm_source=shelf_website&utm_medium=cta&utm_content=blog_inline_signup) and experiment with custom fields[Book a demo](https://www.shelf.nu/demo?utm_source=shelf_website&utm_medium=cta&utm_content=blog_inline_demo) to see custom fields in actionRead our [step-by-step guide](/knowledge-base/adding-additional-fields-to-assets) to creating custom fields
