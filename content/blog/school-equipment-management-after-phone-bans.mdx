...
<StatBlock stats={[
  { value: "33", label: "U.S. states with phone bans" },
  { value: "$0", label: "state funding for replacement equipment" },
  { value: "$25K–$75K", label: "typical equipment cost per school" }
]} />
...
<StatBlock stats={[
  { value: "$2.5K", label: "Podcast (bare minimum)" },
  { value: "$12K", label: "Yearbook (well-equipped)" },
  { value: "$16K", label: "Broadcast (well-equipped)" },
  { value: "$35K", label: "Film/CTE (well-equipped)" }
]} />
...
[Eastern Michigan University](/case-studies/eastern-michigan-university) manages theatre and media equipment across departments using QR-code-based checkout.

<PullQuote attribution="Dustin D. Miller" role="Technical Director & Production Manager, Eastern Michigan University">
...
<SummaryBox title="Your 5-Step Action Plan">
...
3. **Build a funding strategy.** Our [funding guide](/blog/how-to-fund-school-media-equipment-grants-perkins-cte-title-iv) maps every viable path — Perkins V, Title IV-A, state grants, DonorsChoose, and local approaches.
