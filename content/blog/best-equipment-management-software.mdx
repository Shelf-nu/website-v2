...
![Shelf asset tracking dashboard](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/blog/670930df362ae204a86346ee_65d472ff03f2c30502ccfb49_asset-index.webp)
...
<ComparisonTable
  headers={["Shelf", "Cheqroom", "Sortly", "Snipe-IT", "EZO", "Asset Panda", "Reftab"]}
  rows={[
    {
      label: "Free plan",
      values: [
        "Yes (unlimited assets, 1 user)",
        { value: "No — demo only", warning: "No free plan or trial. Must request a demo to test the software." },
        "Yes (100 items, 1 user)",
        "Yes (self-hosted)",
        "Trial only",
        "Trial only",
        "Yes (50 assets, unlimited users)"
      ]
    },
    {
      label: "Paid pricing",
      values: [
        { value: "$67/mo flat", link: "/pricing" },
        { value: "From $184/admin/mo", warning: "Hidden minimum admin requirement — not disclosed on pricing page. Core tier ($184) locked to 1 location, no reporting, no custom roles." },
        { value: "$49–$299/mo", warning: "Caps on both items and users per tier. Multiple reviewers report steep renewal price hikes after year one." },
        "$40–$250/mo (hosted)",
        { value: "From $40/mo (250 items)", warning: "Scales steeply with items: $40/mo for 250 → $136/mo for 1,500. 'Unlimited users' subject to fair-use policy." },
        { value: "~$50/user/mo", warning: "Now behind 'Request Quote' wall. Historical floor: $50/user/mo, minimum 5 users ($3,000/year)." },
        "From $31.25/mo"
      ]
    },
    {
      ...
      values: [
        ...
        "Per admin seat",
        "Per user + item cap",
        "Free self-host or hosted",
        "Per item count",
        "Per user",
        "Per asset count (unlimited users)"
      ]
    },
    { label: "Open source", values: [true, false, false, true, false, false, false] },
    { label: "Self-host option", values: [true, false, false, true, false, false, false] },
    {
      label: "QR-first design",
      values: ["Yes", "Has QR", "Has QR", "Has QR", "Has QR", "Has barcode/QR", "Has QR"]
    },
    { label: "Booking / reservations", values: [true, true, false, false, true, true, true] },
    {
      label: "Custody chain",
      values: ["Yes", "Yes", "Folder-based", "Basic assign", "Basic", "Yes (with signatures)", "Basic assign"]
    },
    {
      label: "Kit management",
      values: [true, true, false, false, "Limited", false, "Paid plans"]
    },
    {
      label: "Maintenance / CMMS",
      values: [
        "Tracking, not full CMMS",
        false,
        false,
        false,
        { value: "Add-on", warning: "Maintenance is priced separately per admin user — not included in base plans." },
        "Limited",
        "Business tier"
      ]
    },
    { label: "Depreciation tracking", values: [false, false, false, true, true, true, false] },
    { label: "License tracking", values: [false, false, false, true, false, false, "Limited"] },
    {
      label: "Native mobile app",
      values: ["iOS (Shelf Companion); Android in development; PWA on any browser", "Yes (iOS/Android)", "Yes (iOS/Android)", false, "Yes (iOS/Android)", "Yes (iOS/Android)", "Yes (iOS/Android)"]
    },
    {
      label: "Best for",
      values: [
        "Schools, media, shared equipment",
        "AV/media production",
        "Simple visual inventory",
        "IT asset lifecycle",
        "Mid-market operations",
        "Customizable enterprise",
        "IT teams (unlimited users)"
      ]
    }
  ]}
/>
...
- **Native iOS app + PWA** — the free Shelf Companion app is on the App Store for iPhone (field workflows: scan, audit, custody, bookings). The web app also runs as a PWA in any modern phone browser. Android is in development.
...
- **No Android app yet** — Shelf Companion is currently iOS-only. Android is in development with no committed date. If your team needs Android right now, Cheqroom, Reftab, Sortly, EZO, Asset Panda, and ShareMyToolbox all ship both platforms today.
- **Audit evidence is web-only on mobile** — you can run, complete, and review audits from the iPhone Companion app, but adding photos or notes to an individual audit scan is currently web-only. On the iOS roadmap.
...
![Shelf booking calendar for equipment reservations](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/blog/6712550f40d94ec87ac3b6de_Calendar%20solution%20page.jpeg)
...
- **Native mobile apps on iOS and Android** — both platforms today (Shelf has iOS only).
...
![Mobile QR scanning for equipment checkout](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/solutions/phone-qr-alt-2.png)
...
**Pricing:** Essentials $40/mo (250 items) → Advanced $55/mo → Premium $65/mo. Scales steeply with item count. Maintenance is a separate add-on. Verify current pricing at [ezo.io](https://ezo.io/ezofficeinventory/pricing/).

[Read full Shelf vs EZOfficeInventory comparison →](/alternatives/ezofficeinventory)

---

![Asset detail page with custom fields and QR code](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/blog/65854ee13401439b60656eb2_asset-info.jpg)
...
**Pricing:** Free (50 assets, unlimited users) → Starter $31.25/mo → Business $125/mo → Enterprise (custom). All plans include unlimited users. Verify at [reftab.com/pricing](https://www.reftab.com/pricing).
...
![Shelf dashboard showing equipment status and bookings](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/blog/6584589239f5291e33fe59cf_dashboard-2.jpg)
...
- **If you need higher-ed AV checkout specifically:** Cheqroom — purpose-built for media/AV rooms, university case studies, native mobile app on iOS and Android (Shelf has iOS only today)
...
- **Best overall:** Shelf or Cheqroom — both have booking, kits, and custody. Shelf wins on pricing (flat vs per-admin), open source, and a native iOS Companion app. Cheqroom wins on Android coverage today and AV-specific heritage.
...
- **Best overall:** Shelf — QR scanning works on any phone (browser or the free [Shelf Companion app](/mobile-app) on iPhone), custody chain for crew handoffs, location tracking across sites, flat pricing for entire crew. Android is in development.
...
- **For a university media department**, we'd choose between Shelf and Cheqroom. Both handle the core workflow with native iOS apps. The choice comes down to: do you value open source and flat pricing (Shelf), or Android support today and AV-specific heritage (Cheqroom)?
...
2. **How many people need access?** If it's more than 10, per-user pricing (Asset Panda) and per-admin pricing (Cheqroom at $184+/admin) add up fast. Flat pricing (Shelf), unlimited users (Reftab), and free self-hosting (Snipe-IT) don't penalize team size.
3. **How much time do you have to set this up?** Sortly and Shelf can be operational in an afternoon. Asset Panda is known for requiring weeks of complex workflow configuration before you can scan your first item. EZO sits in between. If you need to be tracking equipment by Friday, eliminate the tools that need a multi-week implementation.
4. **What's your technical capacity?** If you have a sysadmin who can manage a server, Snipe-IT's free self-hosting is compelling. If you want zero setup, a cloud-hosted SaaS (Shelf, Cheqroom, Sortly, EZO) is the right path.
...
*Last updated: May 2026. We review and update this page quarterly. If you notice something that's changed or inaccurate, [let us know](mailto:carlos@shelf.nu).*
