...
- **Audit evidence is web-only on mobile** — you can run, complete, and review audits from the Shelf Companion app, but adding photos or notes to an individual audit scan is currently web-only. On the mobile roadmap.
