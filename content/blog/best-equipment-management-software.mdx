...
**Limitations:**
- **Expensive per-admin pricing** — plans start at $184/admin/month (Core), scaling to $275 (Business) and $367 (Enterprise). The Core tier is limited to 1 location and strips out custom roles, reporting, and document generation. Minimum admin counts apply but aren't disclosed upfront.
...
**Limitations:**
- **Per-asset pricing** — Free covers 50 assets, Starter ($31.25/mo) and Business ($125/mo) scale by asset count. Large inventories get expensive.
