...
|---|---|---|---|---|---|---|---|
| **Free plan** | Yes (unlimited assets, 1 user) | No (demo request only) | Yes (100 items, 1 user) | Yes (self-hosted) | No (trial only) | No (trial only) | Yes (50 assets, unlimited users) |
| **Paid pricing** | $67/mo flat (unlimited users) | From $184/admin/mo | $49-$299/mo (user + item caps) | $40-$250/mo (hosted) | From $40/mo (250 items) | ~$50/user/mo (min 5 users) | From $31.25/mo (by asset count) |
...
| **Maintenance / CMMS** | Tracking, not full CMMS | No | No | No | Add-on (separate fee) | Limited | Yes (Business tier) |
