  ...
  rows={[
    {
      ...
      values: [
        ...
        { value: "No", warning: "No free plan or trial. Must request a demo to test the software." },
    ...
    },
    {
      ...
      values: [
        ...
        { value: "From $184/admin/mo", warning: "Minimum admin counts apply but aren't disclosed upfront. Core tier limited to 1 location with no reporting or custom roles." },
