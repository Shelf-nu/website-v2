...
Ensure that equipment is properly labeled with [asset tags](https://store.shelf.nu) and organized for easy identification. This makes it simpler for students to locate the equipment they need and prevents confusion or mistakes during the reservation process. For all things asset labels and tags, check this page.
