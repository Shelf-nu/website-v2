...
seo:
  ...
  keywords: []
  noindex: false
image: "https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/blog/the-importance-of-equipment-usage-agreements-for-asset-protection.jpeg"
---
...
For those just getting started with formal asset management, a written agreement is one of the simplest protections to put in place. Shelf does not generate or store these documents for you, so keep the signed copy wherever your records already live.
...
Whether you manage a few high-value items or a large distributed inventory, signed equipment contracts are a simple risk management essential. Don't learn lessons the hard way. Adapt the templates above to your needs, and use Shelf to keep the custody record of who holds what.
