...
- 4-6x **Zoom H1essential** ($80 each) — the new version of the H1n, which has been used in journalism programs for over a decade. The H1essential adds 32-bit float recording, meaning students can't clip or distort audio even if levels are set wrong. This is the single most important piece of equipment for a newspaper program after a phone ban.
