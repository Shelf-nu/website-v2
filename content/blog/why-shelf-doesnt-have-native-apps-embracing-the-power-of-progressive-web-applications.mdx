...
<Callout type="info" title="Update — April 2026">

We still believe in web-first. But after listening to field teams, we've decided to build a native companion app for iOS and Android — purpose-built for scanning, audits, and custody management. The web app remains the command center. Read the full story: [Why We're Building the Shelf Mobile App](/blog/why-were-building-the-shelf-mobile-app).
