...
Chain-of-custody discipline is the first fix. Require scans at every handoff and tie them to work orders, feeders, or span numbers so gear is always linked to a job. Shelf’s [**chain-of-custody**](/features/custody) auditing provides a single source of truth for those events.
