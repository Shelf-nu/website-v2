...
| **Mobile experience** | Web-based, reviewers note room for improvement | Native iOS app (Shelf Companion) + mobile web; Android in development |
...
Shelf is designed mobile-first. QR scanning, custody transfers, and booking confirmations all work in any smartphone browser. For an iPhone-native field experience, the free [Shelf Companion app](/mobile-app) is on the App Store; Android is in development. Either path, the workspace, login, and data are the same as the web.
