...
Hardcat ships extensive enterprise reporting around fixed-asset compliance, depreciation, and audit trails — long a strength of the platform. Shelf's [Reports area](/features/reports) covers a different surface: ten built-in operational reports for bookings, custody, and asset utilization (Booking Compliance, Top Booked Assets, Monthly Booking Trends, Overdue Items, Asset Inventory, Asset Activity Summary, Asset Utilization, Idle Assets, Asset Distribution, Custody Snapshot). Every report exports to CSV; chart-based reports also export to PDF.
