...
| **Operational reports** | Comprehensive register, depreciation, and audit reports | Ten built-in operational reports (booking compliance, utilization, idle, custody, distribution) with CSV/PDF export |
