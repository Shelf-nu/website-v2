...
| **Mobile experience** | Native app (reviewers note performance issues) | Native iOS app (Shelf Companion) + mobile web; Android in development |
...
Shelf is designed mobile-first. QR scanning, custody transfers, and booking confirmations all work in any smartphone browser, and the free [Shelf Companion app](/mobile-app) is on the App Store for an iPhone-native experience. Android is in development. Either path, no app store updates to manage on the web side, and no performance gap between desktop and mobile.
