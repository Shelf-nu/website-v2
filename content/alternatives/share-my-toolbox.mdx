...
Shelf gives users a choice. QR labels work with any smartphone camera in the browser — no app install needed for the web flow. For an iPhone-native field experience, the free [Shelf Companion app](/mobile-app) is on the App Store and Google Play. Either path uses the same Shelf workspace and login.
