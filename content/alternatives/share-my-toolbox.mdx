...
| **Mobile app** | Native iOS and Android | Native iOS app (Shelf Companion) + mobile web; Android in development |
...
Shelf gives users a choice. QR labels work with any smartphone camera in the browser — no app install needed for the web flow. For an iPhone-native field experience, the free [Shelf Companion app](/mobile-app) is on the App Store; Android is in development. Either path uses the same Shelf workspace and login.
...
- **Android coverage today**: ShareMyToolbox ships a native Android app alongside iOS. Shelf has Companion on iOS, with Android in development
