...
Wasp Barcode includes a library of inventory and asset reports rooted in its barcode/scanner workflow. Shelf includes a built-in [Reports area](/features/reports) on every plan with ready-to-run reports for the modern equipment-operations workflow — Booking Compliance, Top Booked Assets, Top Booked Kits, Monthly Booking Trends, Overdue Items, Asset Inventory, Asset Activity Summary, Asset Utilization, Idle Assets, Asset Distribution, and Custody Snapshot. Every report exports to CSV; chart-based reports also export to PDF.
