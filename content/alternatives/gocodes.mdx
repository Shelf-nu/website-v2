...
GoCodes' reporting centers on QR-scan history and basic asset lists. Shelf includes a built-in [Reports area](/features/reports) with ten ready-to-run reports — Booking Compliance (on-time vs late returns), Top Booked Assets, Monthly Booking Trends, Overdue Items, Asset Inventory, Asset Activity Summary, Asset Utilization, Idle Assets, Asset Distribution, and Custody Snapshot. Every report exports to CSV; chart-based reports also export to PDF.
