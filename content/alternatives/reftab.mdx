...
| **Mobile experience** | Native iOS and Android apps | Native iOS app (Shelf Companion) + mobile web; Android in development |
...
| **Operational reports** | Asset and assignment reports with CSV export | Ten built-in reports (booking compliance, utilization, idle, custody, distribution) with CSV/PDF export |
...
Shelf is a mobile-first web application. The same interface works on desktop and mobile browsers with consistent behavior — QR scanning, custody transfers, and booking confirmations work in either context. For field-heavy iPhone workflows, the free [Shelf Companion app](/mobile-app) is also on the App Store; Android is in development. The web stays the canonical experience either way.
...
- **Native mobile on both iOS and Android**: Reftab ships native apps on both platforms today. Shelf has Companion on iOS, with Android in development
