...
| **Operational reports** | Strong maintenance, work-order, and asset-history reports | Ten built-in operational reports for bookings/custody/utilization (booking compliance, utilization, idle, custody, distribution) with CSV/PDF export |
