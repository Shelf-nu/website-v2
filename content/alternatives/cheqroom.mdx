...
| **Mobile experience** | Native app (some feature gaps vs. web) | Native iOS app (Shelf Companion) + mobile web; Android in development |
...
Shelf is mobile-first by design. QR scanning, custody transfers, booking confirmations, and return verification all work in any smartphone browser. For an iPhone-native field experience, the free [Shelf Companion app](/mobile-app) is on the App Store — same workspace, same data, focused on the field workflows. Android is in development. Either path, the web stays the source of truth for configuration, reporting, and admin work.
