...
No. Shelf works in any phone browser as a progressive web app. QR scanning uses the device's built-in camera — nothing to install, no app store updates to manage, no feature gaps between mobile and desktop.
