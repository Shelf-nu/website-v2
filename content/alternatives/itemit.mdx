...
| **Operational reports** | Asset list and audit exports | Built-in operational reports (booking compliance, top booked assets and kits, utilization, idle, custody, distribution) with CSV/PDF export |
...
![Asset search and filtering across your inventory](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/features/search-hero.webp)
