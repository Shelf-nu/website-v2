...
Limble's reporting strength is maintenance KPIs — work-order completion, MTBF, and PM compliance — built around the CMMS data model. Shelf's [Reports area](/features/reports) covers a different surface: built-in operational reports for bookings, custody, and asset utilization (Booking Compliance, Top Booked Assets, Top Booked Kits, Monthly Booking Trends, Overdue Items, Asset Inventory, Asset Activity Summary, Asset Utilization, Idle Assets, Asset Distribution, Custody Snapshot). Every report exports to CSV; chart-based reports also export to PDF.
