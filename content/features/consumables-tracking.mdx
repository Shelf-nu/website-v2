...
Set a **minimum quantity** threshold on any quantity-tracked item and Shelf watches it for you. When a stock adjustment or custody assignment takes available stock to or below that minimum, the **workspace owner** gets an email alert and an in-app notification goes to whoever made the change. The **Low stock** badge on the asset page clears automatically once stock rises back above the threshold.
