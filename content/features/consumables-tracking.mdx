...
- **Bookings**: reserve N units from available stock for a date range, and adjust the booked quantity as plans change. With **book-by-model**, you reserve N of a model and scan-to-assign the specific units at checkout.
