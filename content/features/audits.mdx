...
![Audit overview showing live statistics — expected, found, missing, and unexpected counts](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/features/audits-overview-pending.webp)
...
![Completed audit overview with final statistics, timestamps, and archived audit images](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/features/audits-overview-completed.webp)
...
- **Archive completed audits**: Remove finished audits from the default list view without deleting them. Archived audits stay searchable via the status filter for historical reference.
