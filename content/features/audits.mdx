...
Assign the audit to a team member. They open a dedicated scan page on any phone or tablet — in any browser, or in the free [Shelf Companion app](/mobile-app) on iPhone and Android — and start scanning QR labels. Each scan registers the asset as **Found**.
