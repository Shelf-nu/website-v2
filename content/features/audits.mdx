...
- **Runs on any device**: Browser-based scanning on phone, tablet, or laptop, and a native iPhone experience via the [Shelf Companion app](/mobile-app). Android is in development.
