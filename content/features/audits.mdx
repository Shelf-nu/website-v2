...
Yes. Admins and owners can archive any audit that is **Completed** or **Cancelled**. Open the audit, click the actions dropdown (⋯), and select **Archive**. You will be asked to confirm before the action is applied. Archiving removes the audit from the default list but it remains accessible by filtering for the Archived status. Archiving is permanent — it cannot be undone.
