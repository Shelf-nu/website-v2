...
{/* TODO: Screenshot needed: Asset detail page in display mode with the pencil icon revealed on hover (PR #2486) */}
...
{/* TODO: Screenshot needed: Inline editor open on the Description field, showing Save and Cancel buttons (PR #2486) */}
