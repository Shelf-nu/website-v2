...
If you want a different layout — swap QR ID for Asset ID, add your own logo, change the font — use the [asset-label-designer tool](/tools/asset-label-designer), or switch the ID display in [change asset label information](/knowledge-base/asset-identifiers-qr-id-sam-id-property-id).

### What about DYMO, Brother, or Zebra label printers?

Those are roll-fed thermal printers — different workflow. Shelf supports them directly in the app via the asset page Print button. See [change asset label information](/knowledge-base/asset-identifiers-qr-id-sam-id-property-id).
