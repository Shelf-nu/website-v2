...
- [Asset Identifiers: QR ID, SAM ID, Property ID](/knowledge-base/asset-identifiers-qr-id-sam-id-property-id) — choose what prints on your labels and how assets are numbered
