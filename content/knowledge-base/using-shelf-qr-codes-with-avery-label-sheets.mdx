...
If you want a different layout — swap QR ID for Asset ID, add your own logo, change the font — use the [asset-label-designer tool](/tools/asset-label-designer), or switch the ID display in [change asset label information](/knowledge-base/change-asset-label-information).
