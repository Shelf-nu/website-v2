...
If you run the same report every month, save the filter once and pick it from **Saved Filters** each time. See [Saved Filters](/knowledge-base/advanced-asset-index-complete-guide#saved-filters).
