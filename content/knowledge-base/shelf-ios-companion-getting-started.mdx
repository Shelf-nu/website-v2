...
- **Creating, editing, or rescheduling a booking from the app.** You can build a booking by scanning gear into it, check items out, and check them back in on mobile, but setting the booking up (dates, custodian, details) is still web-only.
