...
- **Claiming a brand new QR code as a base or self-service member.** Admins and owners can now claim an unclaimed sticker in the app (see step 4). Everyone else still goes through the web app for that one step.
