...
- **An iPhone running iOS 15.1 or later, or an Android phone.** The same app is on both stores and the two builds carry the same features.
...
- Watch the **Expected / Found / Not scanned / Unexpected** counts update in real time as you scan. Urgency surfaces in the UI as you go.
