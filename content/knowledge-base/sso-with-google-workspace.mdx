...
It is very important to send this file to your support contact at Shelf to complete the SSO setup process. If you are not sure where to send this file, you can always reach us at [hello@shelf.nu](mailto:hello@shelf.nu).
...
![No workspace assigned page shown to SSO users with no team org](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/knowledgebase/nopersonalworkspaceassigned.png)
...
If someone is affected, ask them to sign out and sign back in. If they still do not appear as an available custodian afterwards, that is a group mapping problem rather than this one — check [Step 9](#step-9-map-google-workspace-groups-inside-shelf).
...
This means SSO-managed field teams can scan, run audits, manage custody, and handle booking check-in/check-out from their phones using the same single sign-on the organization already requires. See [Getting Started with Shelf Companion](/knowledge-base/shelf-ios-companion-getting-started) for the full mobile sign-in walkthrough.
