...
- The **Custody** column on the [advanced asset index](/knowledge-base/advanced-asset-index-complete-guide), including its simple-mode equivalent
...
- The **dashboard**'s custodian widgets, the **command palette**, [reports](/features/reports), and **audit PDFs**
