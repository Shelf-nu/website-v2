...
- **It reaches every surface, not just the lists.** The same rule applies on an individual asset's page and a kit's page, in the [Shelf Companion](/mobile-app) app on the asset list, the kit list and a kit's detail screen, and in the custodian picker a quantity-tracked asset offers. Opening one item at a time gets a Self-service or Base user no further than the index does.
