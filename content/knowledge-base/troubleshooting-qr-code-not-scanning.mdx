...
- If your labels carry your own barcode value (e.g. `LAPTOP-0001`), type that — with the [alternative-barcodes add-on](/knowledge-base/alternative-barcodes) it resolves to the asset or kit it is registered on, including values shaped like a SAM ID
