...
![Actions menu open on an Archived audit showing Delete in red and Download Receipt below it](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/knowledgebase/delete-audits-1.webp)
...
![Bulk delete confirmation dialog — "Delete 2 audits" with type-DELETE confirmation field and disabled Delete button](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/knowledgebase/delete-audits-2.webp)

## What Gets Deleted

Permanently deleting an audit removes:

- All scan records (the Found, Missing or Unexpected status held against each asset)
