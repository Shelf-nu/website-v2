...
![Assets list showing the new code chip on every row — same chip primitive renders on kits, bookings, audits, and locations](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/knowledgebase/preferred-display-code-list-chips.webp)

![Settings → General → Preferred display code — one dropdown controls every list chip across the app](https://qliecghuzfchfjwaisyx.supabase.co/storage/v1/object/public/website-images/knowledgebase/preferred-display-code-setting.webp)
