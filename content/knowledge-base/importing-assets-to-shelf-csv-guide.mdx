...
> **Plan requirement:** CSV import (and export) require the **Plus**, **Team**, or **Enterprise** plan. The free Personal plan does not include CSV import. See [pricing](/pricing) for plan details.
...
| `imageUrl` | No | Public image link (`.png`, `.jpg`, `.jpeg`) | "https://example.com/image.jpg" |
